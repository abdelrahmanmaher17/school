...
class studentlogin extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      appBar: AppBar(title: const Text("hello student",
              style: TextStyle(
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                CustomTextField(inputType: TextInputType.name, hintText: "student ID", obscureText:false ),
                const SizedBox(
                  height: 30,
                ),
                ...
                return  Center(
                  ...
                  actions: [
                    Container(
                      ...
                      child: TextButton(
                        onPressed: () {
                        Navigator.of(context).pushReplacementNamed("studentwelcom");
                      },
